...
function buildAdvancedSplit4(metabolic) {
  return [
    {
      ...
      bloques: [
        ...
        ...(metabolic
          ? [{ nombre: 'Cardio', ejercicios: [exCardio('Cinta inclinada', 'RPE 7/10', '15-20 min')] }]
          : []),
      ],
    },
    {
          ...
          ? [
              {
                ...
                ejercicios: [
                  ...
                  exAdv('Wall balls', 'Full body', '1', '15', 'Fluido'),
                  exAdv('Kettlebell swings', 'Cadena posterior', '1', '15', 'Cadera explosiva'),
                  exAdv('Remo en cuerda', 'Espalda', '1', '10', 'Alternativa: remo mancuerna'),
      ...
      bloques: [
        {
          ...
          ejercicios: [
            ...
            exAdv('Curl barra Z', 'Bíceps', '3', '10', 'Sin impulso'),
            exAdv('Extensiones tríceps', 'Tríceps', '3', '10', 'Superserie con curl'),
          ],
        },
        {
          nombre: 'Core (corto)',
...
function buildAdvancedSplit5(metabolic) {
  const four = buildAdvancedSplit4(metabolic);
  return [
    { ...four[0] },
    {
      dia: 'Día 2 — Espalda + Bíceps',
      enfoque: 'Tirón',
      bloques: four[2].bloques.filter((b) => b.nombre !== 'Cardio'),
    },
    { ...four[1] },
    {
...
export function buildAdvancedSplit(dias, metabolic) {
  if (dias === 5) return buildAdvancedSplit5(metabolic);
  return buildAdvancedSplit4(metabolic);
}
